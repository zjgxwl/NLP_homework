...
def get_args_parser(subparsers):
    ...
    # Model parameters
    subparsers.add_argument('--model', default='bert', type=str, metavar='MODEL', help='Name of model to train')
    ...
    subparsers.add_argument('--lr', type=float, default=0.3, metavar='LR', help='learning rate (default: 0.03)')
    ...
    # Data parameters
    subparsers.add_argument('--data_path', default='/home/yzy/storage/free_l2p_text_diverse/data/toutiao_cat_data.txt', type=str, help='dataset path')
    subparsers.add_argument('--dataset', default='text', type=str, help='dataset name')
    ...
    subparsers.add_argument('--nb_classes', default=10, type=int)
    subparsers.add_argument('--pad_size', default=32, type=int)
    ...
    subparsers.add_argument('--base_mode', default=True, type=bool, help='if baseline')
    ...
    subparsers.add_argument('--top_k', default=2, type=int, )
    ...
    #New optimizer
    subparsers.add_argument('--optim', type=str, default='Adam',
                        help="选择哪个优化器，默认Adam")
    # subparsers.add_argument('--lr', type=float, default=1e-3,
    #                     help="学习率大小，默认0.001")
    subparsers.add_argument('--momentum', type=float, default=0.,
                        help="动量大小，默认0")
    subparsers.add_argument('--nu', type=float, default=0.7,
                        help="QHM参数，默认0.7")
    subparsers.add_argument('--nu1', type=float, default=0.7,
                        help="QHAdam参数nu1，默认0.7")
    subparsers.add_argument('--nu2', type=float, default=0.7,
                        help="QHAd am参数nu2，默认0.7")
    subparsers.add_argument('--beta1', type=float, default=0.9,
                        help="beta1，默认0.9")
    subparsers.add_argument('--beta2', type=float, default=0.999,
                        help="beta2，默认0.999")
    subparsers.add_argument('--beta3', type=float, default=0.999,
                        help="beta3，默认0.999")
    subparsers.add_argument('--eps', type=float, default=1e-8,
                        help="epsilon，默认1e-8")
    subparsers.add_argument('--weight_decay', type=float, default=5e-4,
                        help="weight_decay，默认5e-4")
    subparsers.add_argument('--momentum_decay', type=float, default=4e-3,
                        help="momentum_decay，默认4e-3")
    subparsers.add_argument('--amsgrad', default=False, action='store_true',
                        help="是否使用amsgrad，默认False")
    '''修改优化器添加的参数'''
    subparsers.add_argument('--nesterov', default=False, action='store_true',
                        help="是否使用nesterov，默认False")
    subparsers.add_argument('--NAdam', default=False, action='store_true',
                        help="是否使用Nadam，默认False")
    subparsers.add_argument('--Adamax', default=False, action='store_true',
                        help="AdamW是否使用Adamax，默认False")
    subparsers.add_argument('--regress', default=False, action='store_true',
                        help="是否使用regress，默认False")
    subparsers.add_argument('--diff1', default=False, action='store_true',
                        help="是否使用diff1，默认False")
    subparsers.add_argument('--diff2', default=False, action='store_true',
                        help="是否使用diff2，默认False")
